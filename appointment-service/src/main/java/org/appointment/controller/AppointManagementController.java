...
public class AppointManagementController {
  ...
  @GetMapping(
      path = "/api/v1/appointment/{patientId}",
      consumes = {"application/json", "application/xml"},
      produces = {"application/json", "application/xml"})
  ...
  @DeleteMapping(
      ...
      consumes = {"application/json", "application/xml"},
      produces = {"application/json", "application/xml"})
  public String deleteAppointments(@PathVariable String patienId) {
    return appointmentManagementServiceImpl.deleteAppointment(patienId);
  }
}
